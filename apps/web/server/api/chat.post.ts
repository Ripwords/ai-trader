...
function buildSystemPrompt(hasGhostfolio: boolean): string {
  return [
    ...
    '',
    'RESEARCH (research_ticker, synthesize_decisions):',
    '- research_ticker runs multi-perspective analysis on a symbol — 4 deterministic analysts + LLM investor personas (Buffett, Munger, Burry, Druckenmiller, Wood). Use it when the user asks "what do you think of X", "is X a buy", or wants a research dive.',
    '- Default to 3 personas (buffett, burry, wood) for a balanced read; ask before running all 5 (cost).',
