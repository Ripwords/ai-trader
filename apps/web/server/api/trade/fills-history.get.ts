import type { Fill } from '../../llm/http'
import { getApiClient } from '../../llm/http'

/**
 * Proxy to the api container's GET /trade/fills/history. Session-auth via
